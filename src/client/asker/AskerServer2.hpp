...
class SRC_API AskerServer2 : public hub::client::AskerInterface
{
  public:
    ...
    /// \param port [in] is the openned port for the hub service running on server you want to
    /// connect (HUB_SERVICE_PORT by default)
    ///
    explicit AskerServer2( const std::string& ipv4 = HUB_SERVICE_IPV4,
